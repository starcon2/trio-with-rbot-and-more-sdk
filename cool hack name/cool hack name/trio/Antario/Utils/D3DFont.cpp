...
HRESULT CD3DFont::InitDeviceObjects(LPDIRECT3DDEVICE9 pd3dDevice)
{
	...
	this->iWidth = static_cast<float>([this]()
		{
			SIZE size;
			this->GetTextExtent("WJ", &size);
			return size.cx;
	...
	DWORD dwFlags)
{
	...
	while (*strText)
	{
		...
		if (c != _T(' '))
		{
			...
			{
				auto dropshadow_colour = D3DCOLOR_RGBA(1, 1, 1, get_a(dwColor));
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + 0 + 0.5f, sy + h + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx1, ty2);
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + 0 + 0.5f, sy + 0 + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx1, ty1);
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + w + 0.5f, sy + h + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx2, ty2);
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + w + 0.5f, sy + 0 + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx2, ty1);
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + w + 0.5f, sy + h + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx2, ty2);
				*pVertices++ = InitFont2DVertex(D3DXVECTOR4(sx + 0 + 0.5f, sy + 0 + 0.5f, 1.0f, 1.0f), dropshadow_colour, tx1, ty1);
				dwNumTriangles += 2;
			}
