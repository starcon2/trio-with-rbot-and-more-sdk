...
public:
	void EnableInput(bool bEnable) {
		return Utils::CallVFunc<11, void, bool>(this, bEnable);
	}

	void ResetInputState() {
		return Utils::CallVFunc<39, void>(this);
	}

	bool IsButtonDown(ButtonCode_t code) {
		return Utils::CallVFunc<15, bool, ButtonCode_t>(this, code);
	}

	void GetCursorPosition(int* m_pX, int* m_pY) {
		return Utils::CallVFunc<56, void, int*, int*>(this, m_pX, m_pY);
	}

	char* ButtonCodeToString(ButtonCode_t ButtonCode) {
		return Utils::CallVFunc<40, char*, ButtonCode_t>(this, ButtonCode);
	}

	ButtonCode_t VirtualKeyToButtonCode(int nVirtualKey) {
		return Utils::CallVFunc<45, ButtonCode_t, int>(this, nVirtualKey);
	}

	int ButtonCodeToVirtualKey(ButtonCode_t code) {
		return Utils::CallVFunc<46, int, ButtonCode_t>(this, code);
	}
};
